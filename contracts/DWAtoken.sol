 ...
 * `ERC20` functions.
 */
contract KRPTtoken is Context, ERC20, ERC20Detailed {
     ...
     */
    constructor () public ERC20Detailed("KRPT", "krpt", 18) ERC20(_msgSender()) {
        
        owner = _msgSender();
        totalSupplyofToken = 880000000 * (10 ** uint256(decimals()));
